    ...
    <Card sx={{ height: '100%' }}>
      ...
      <CardContent>
        <List sx={{ px: 2 }}>
          ...
          <ListItem sx={{ py: 1.5 }}>
            <ListItemText primary="Join Date" primaryTypographyProps={{ variant: 'subtitle2' }} />
          ...
          <Divider component="li" />
          <ListItem sx={{ py: 1.5 }}>
            <ListItemText primary="Company" primaryTypographyProps={{ variant: 'subtitle2' }} />
            <Typography variant="subtitle2" color="text.primary">
              Google Inc.
            </Typography>
          </ListItem>
          <Divider component="li" />
          <ListItem sx={{ py: 1.5 }}>
            <ListItemText primary="Tasks" primaryTypographyProps={{ variant: 'subtitle2' }} />
