    ...
    <Grid container spacing={3}>
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5 }}>
          ...
          <Typography variant="subtitle2" gutterBottom>
            <Text color="black">4</Text> out of <Text color="black">6</Text> tasks completed
          </Typography>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5 }}>
          ...
          <Typography variant="subtitle2" gutterBottom>
            <Text color="black">2</Text> out of <Text color="black">8</Text> tasks completed
          </Typography>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5 }}>
          ...
          <Typography variant="subtitle2" gutterBottom>
            <Text color="black">10</Text> out of <Text color="black">20</Text> tasks completed
          </Typography>
